...
class WidgetList extends Component {
  ...
  componentDidMount() {
     ...
     */
    this.state.widgetFrameworkSettings
      .fetchData(apiPath("widget_list", this.props.widgetListId))
  ...
  deleteWidget(widgetId) {
     ...
     */
    this.state.widgetFrameworkSettings
      .fetchData(apiPath("widget", this.props.widgetListId, widgetId), {
        method: "DELETE"
      })
      .then(this.updateWidgetList)
      .catch(this.state.widgetFrameworkSettings.errorHandler)
  ...
  renderListBody() {
    return this.state.widgetInstances.map(widgetInstance =>
  ...
  renderWidgetBody(widgetProps) {
    const Renderer =
      this.state.widgetFrameworkSettings.renderers[widgetProps.reactRenderer] ||
      this.state.widgetFrameworkSettings.defaultRenderer
    return <Renderer {...widgetProps} />
  }
